...
ActiveRecord::Schema.define(version: 2019_08_04_224248) do
  ...
  create_table "presences", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["school_class_id"], name: "index_presences_on_school_class_id"
  ...
  create_table "responsible_legals", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["student_id"], name: "index_responsible_legals_on_student_id"
  end
  ...
  create_table "students", force: :cascade do |t|
    ...
    t.boolean "family_bag", default: false
    t.string "birth_certificate_number"
  end
